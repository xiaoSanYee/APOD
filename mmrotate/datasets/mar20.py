...
class MAR20Dataset(CustomDataset):
    ...
    """
    CLASSES = ('A2', 'A10', 'A19', 'A1', 'A13', 'A20', 'A17', 'A16', 'A14', 'A9', 'A5', 'A7', 'A4', 'A18', 'A8', 'A11', 'A3', 'A15', 'A12', 'A6')

    PALETTE = [(9, 80, 61), (84, 105, 51), (74, 65, 105), (166, 196, 102),
    ...
    def __init__(self,
        ...
        super(MAR20Dataset, self).__init__(ann_file, pipeline, **kwargs)
