...
class DOTA_HazeDataset(CustomDataset):
    ...
    CLASSES = ('large-vehicle', 'swimming-pool', 'helicopter', 'bridge',
               ...
               'ground-track-field', 'small-vehicle', 'baseball-diamond', 'tennis-court',
               'roundabout', 'storage-tank', 'harbor', 'container-crane',
               'airport', 'helipad')

    PALETTE = [(255, 0, 0), (189, 183, 107), (138, 43, 226), (165, 42, 42),
               (0, 255, 0), (255, 128, 0), (255, 0, 255), (0, 255, 255),
               (255, 193, 193), (255, 255, 0), (255, 250, 205), (0, 139, 139),
               (0, 51, 153), (147, 116, 116), (0, 0, 255), (201, 57, 1),
    ...
    def __init__(self,
        ...
        super(DOTA_HazeDataset, self).__init__(ann_file, pipeline, **kwargs)
