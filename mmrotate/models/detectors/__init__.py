...
from .base import RotatedBaseDetector_DoubleBranch
from .two_stage_DB import RotatedTwoStageDetector_DoubleBranch
from .oriented_rcnn_DB import OrientedRCNN_DoubleBranch
...
__all__ = [
    ...
    'RotatedSingleStageDetector', 'RotatedFCOS', 'RotatedBaseDetector_DoubleBranch', 'RotatedTwoStageDetector_DoubleBranch', 'OrientedRCNN_DoubleBranch',
]
